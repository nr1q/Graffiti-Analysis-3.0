...
//              }
                ...
                ofVec3f * pts =  QUAD.getScaledQuadPoints(W, H);
...
//      }
        ...
        if(Contour.nBlobs > 0){
                ...
                if(!accurateQuad){
                        ...
                        ofVec3f *  src = QUAD.getQuadPoints();

                        CW.calculateMatrix(src, dst);
                        ofVec3f out = CW.transform(tmpX, tmpY);
...
//-----------------------------------------------------------------------
void laserTracking::getWarpedCoordinates(ofVec3f * dst, float *warpedX, float *warpedY){
        ...
        ofVec3f out = CW.transform(laserX, laserY);
