...
class laserTracking : public guiCustomImpl
{
    public:
        ...
        void setClearZone(vector <ofVec3f> pts);
        ...
        // requires the app to be restarted - maybe we can change this?
        //---------------------------
        ...
        //-----------------------------------------------------------------------
        void getWarpedCoordinates(ofVec3f * dst, float *warpedX, float *warpedY);
