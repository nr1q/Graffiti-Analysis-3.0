...
class polyEditable: public polyAdv
{
    ...
    public:
        ...
        ofPoint transPreRotate,
                transPstRotate; // this is to reverse engineer translation outside draw for mouse input...maybe there is a matri math op to do this better
        float moveBy;
