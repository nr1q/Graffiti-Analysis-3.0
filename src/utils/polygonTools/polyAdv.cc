...
{
    pts.clear();
    pushVertex( ofVec3f( rect.x, rect.y ) );
    pushVertex( ofVec3f( rect.x, rect.y+rect.height ) );
    pushVertex( ofVec3f( rect.x+rect.width, rect.y+rect.height ) );
    pushVertex( ofVec3f( rect.x+rect.width, rect.y ) );
}
