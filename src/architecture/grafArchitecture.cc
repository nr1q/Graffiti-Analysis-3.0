...
{
	float scaleImage = (float)ofGetHeight() /  (float)archImage.getHeight();
	archImage.draw(0,0,scaleImage*archImage.getWidth(),scaleImage*archImage.getHeight());
}
