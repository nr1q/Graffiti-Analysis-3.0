...
void GaManagerApp::setup()
{
    ...
    for (int i = 0; i < 3; i++) {
        ...
        polyButtons[i].pushVertex( ofVec3f(xp+380, yp+40) );
        polyButtons[i].pushVertex( ofVec3f(xp, yp+40) );
...
//--------------------------------------------------------------
void GaManagerApp::setMode (int newMode)
{
    mode = newMode;
}

//--------------------------------------------------------------
int GaManagerApp::getMode()
{
    return mode;
}
